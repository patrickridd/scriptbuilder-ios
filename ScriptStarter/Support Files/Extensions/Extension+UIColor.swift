...
extension UIColor {
    ...
    static var screenDark: UIColor {
        return UIColor(red: 0.26, green: 0.26, blue: 0.26, alpha: 1.0)
    }
    
    static var screenDarkGray: UIColor {
    ...
    static var screenMediumGray: UIColor {
    ...
    static var screenMediumBlue: UIColor {
        return UIColor(red: 0.53, green: 0.72, blue: 0.90, alpha: 1.0)
    }
    
    static var screenDarkBlue: UIColor {
        return UIColor(red: 0.53, green: 0.72, blue: 0.99, alpha: 1.0)
    }
    ...
    static var screenYellow: UIColor {
