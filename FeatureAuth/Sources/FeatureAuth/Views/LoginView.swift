        ...
        content
            .overlay {
                if viewModel.isLoading {
                    AuthLoadingOverlay(message: L10n.Status.signingIn, badge: config.logo)
                }
            }
        ...
        ZStack {
            ...
            FitOrScrollLayout {
                VStack(spacing: sectionGap) {
                    AuthBrandHeader(title: config.appName, subtitle: config.loginSubtitle, compact: true, logo: config.logo)
